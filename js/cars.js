...
export const CARS = [
  {
    ...
    ride: 0.20, hoodY: 1.06,
    cab: { ws: 1.28, rf: 0.05, rb: -1.02, rg: -1.58 },
    hull: [
      [2.15, 0.88, 0.82, 0.78, 0.99],
      [1.95, 0.99, 0.93, 0.95, 0.98],
      [1.60, 1.04, 0.98, 0.99, 0.97],
      [1.28, 1.06, 1.00, 1.00, 0.97],
      [0.66, 1.40, 1.01, 1.00, 0.90],
      [0.05, 1.565, 1.02, 1.00, 0.85],
      [-1.02, 1.55, 1.05, 1.00, 0.84],
      [-1.58, 1.44, 1.07, 0.99, 0.87],
      [-1.98, 1.26, 1.08, 0.96, 0.92],
      [-2.28, 1.06, 1.00, 0.80, 0.97],
    ],
  ...
  },
  {
    ...
    hull: [
      ...
      [0.45, 1.32, 0.97, 1.00, 0.89],
      [-0.20, 1.45, 0.99, 1.00, 0.85],
      [-1.20, 1.42, 1.01, 1.00, 0.85],
  ...
  },
  {
    ...
    hull: [
      ...
      [0.50, 1.36, 0.99, 1.00, 0.90],
      [-0.15, 1.545, 1.01, 1.00, 0.86],
      [-1.35, 1.54, 1.04, 1.00, 0.85],
      [-1.95, 1.44, 1.06, 0.99, 0.87],
      [-2.30, 1.22, 1.06, 0.95, 0.93],
      [-2.56, 1.06, 0.98, 0.80, 0.97],
    ],
  ...
  },
  {
    ...
    hull: [
      ...
      [0.50, 1.32, 0.97, 1.00, 0.90],
      [-0.15, 1.50, 0.99, 1.00, 0.86],
      [-1.35, 1.49, 1.01, 1.00, 0.85],
  ...
  },
  {
    ...
    ride: 0.22, hoodY: 1.15,
    cab: { ws: 1.32, rf: 0.05, rb: -1.22, rg: -1.85 },
    hull: [
      [2.33, 0.97, 0.91, 0.78, 0.99],
      [2.05, 1.08, 1.01, 0.96, 0.98],
      [1.62, 1.13, 1.06, 0.99, 0.97],
      [1.32, 1.15, 1.08, 1.00, 0.97],
      [0.68, 1.48, 1.11, 1.00, 0.91],
      [0.05, 1.655, 1.13, 1.00, 0.86],
      [-1.22, 1.64, 1.16, 1.00, 0.85],
      [-1.85, 1.54, 1.18, 0.99, 0.88],
      [-2.18, 1.32, 1.18, 0.96, 0.94],
      [-2.48, 1.14, 1.06, 0.80, 0.97],
    ],
  ...
  },
  {
    ...
    hull: [
      ...
      [-1.95, 1.84, 1.40, 1.00, 0.92],
      [-2.38, 1.76, 1.42, 0.99, 0.93],
      [-2.58, 1.56, 1.42, 0.97, 0.95],
      [-2.69, 1.32, 1.18, 0.84, 0.98],
    ],
