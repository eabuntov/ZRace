...
export default {
  ...
  'summary.laps.one': '{n} lap',
  'summary.laps.other': '{n} laps',
  'summary.rivals.one': '{n} opponent',
  'summary.rivals.other': '{n} opponents',
  'summary.timeTrial': 'Time trial — just you and the clock',
  'summary.best': 'Your best lap here: {time}',
  'summary.noBest': 'No lap set here yet',
  'opt.laps': 'LAPS',
  ...
  'options.quality': 'VISUAL QUALITY',
  'quality.auto': 'AUTO',
  'quality.performance': 'PERFORMANCE',
  'quality.quality': 'QUALITY',
  'options.qualityNote': 'Performance draws fewer pixels, turns the glow off, thins the scenery and keeps the rivals simple. Quality draws everything at full resolution. Auto starts in between and adjusts itself between races, from how smoothly the last one ran.',
  'options.qualityNow': 'On this machine it is running at {tier}.',
  'tier.0': 'PERFORMANCE',
  'tier.1': 'BALANCED',
  'tier.2': 'QUALITY',
  'options.leanNote': 'Performance mode keeps this off for now.',
  'options.cues': 'DRIVING CUES',
  'options.cuesNote': 'Calls out the braking points and which way the next corner turns, a moment before you reach them. Leaving the road is pointed out whatever this is set to.',
  'opt.on': 'ON',
  'opt.off': 'OFF',
  ...
  'hud.best': 'BEST',
  'hud.boost': 'BOOST',
  'hud.boostReady': 'BOOST READY',
  'hud.startHint': 'HOLD {key} · GO WHEN THE LIGHTS GO OUT',
  'hud.startReady': 'READY · GO WHEN THE LIGHTS GO OUT',
  'cam.chase': 'CHASE CAM',
  'cam.close': 'CLOSE CAM',
  'cam.bonnet': 'BONNET CAM',
  'hint.title': 'Controls',
  ...
  'cue.brake': 'BRAKE',
  'cue.left': 'TURN LEFT',
  'cue.right': 'TURN RIGHT',
  'cue.offTrack': 'OFF TRACK',
  'cue.lateBrake': 'braked too late',
  'cue.rejoin.left': 'TRACK TO THE LEFT',
  'cue.rejoin.right': 'TRACK TO THE RIGHT',
  'cue.rejoin.ahead': 'TRACK AHEAD',
  'cue.metres': '{n} m',
  'cue.pressR': 'R to rejoin',
  'hud.leader': 'LEADER',
  'touch.brake': 'BRAKE',
  'touch.go': 'GO',
  ...
  'msg.boostEmpty': 'BOOST RECHARGING',
  'msg.rejoined': 'BACK ON TRACK',
  'msg.rejoinWait': 'REJOIN IN A MOMENT',
  'msg.resumed': 'RESUMED',
