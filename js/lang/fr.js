...
export default {
  ...
  'ui.selected': 'CHOISI',
  'summary.laps.one': '{n} tour',
  'summary.laps.other': '{n} tours',
  'summary.rivals.one': '{n} adversaire',
  'summary.rivals.other': '{n} adversaires',
  'summary.timeTrial': 'Contre-la-montre — vous et le chrono',
  'summary.best': 'Votre meilleur tour ici : {time}',
  'summary.noBest': 'Pas encore de tour ici',
  'options.quality': 'QUALITÉ VISUELLE',
  'quality.auto': 'AUTO',
  'quality.performance': 'PERFORMANCE',
  'quality.quality': 'QUALITÉ',
  'options.qualityNote': 'Performance dessine moins de pixels, coupe le halo, allège le décor et garde des adversaires simples. Qualité dessine tout en pleine résolution. Auto commence entre les deux et s’ajuste entre les courses, selon la fluidité de la dernière.',
  'options.qualityNow': 'Sur cette machine, il tourne en {tier}.',
  'tier.0': 'PERFORMANCE',
  'tier.1': 'ÉQUILIBRÉ',
  'tier.2': 'QUALITÉ',
  'options.leanNote': 'Le mode Performance le laisse désactivé pour l’instant.',
  'options.cues': 'AIDES DE PILOTAGE',
  'options.cuesNote': 'Annonce les points de freinage et le sens du prochain virage, un peu avant d’y arriver. Une sortie de piste est signalée quel que soit ce réglage.',
  'hud.boostReady': 'BOOST PRÊT',
  'hud.startHint': 'MAINTENEZ {key} · PARTEZ QUAND LES FEUX S’ÉTEIGNENT',
  'hud.startReady': 'PRÊT · PARTEZ QUAND LES FEUX S’ÉTEIGNENT',
  'cam.chase': 'CAMÉRA POURSUITE',
  'cam.close': 'CAMÉRA PROCHE',
  'cam.bonnet': 'CAMÉRA CAPOT',
  'hint.title': 'Commandes',
  'hint.accel': 'accélérer',
  'hint.steer': 'diriger',
  'hint.boost': 'boost',
  'hint.camera': 'caméra',
  'hint.dismiss': 'COMPRIS',
  'cue.brake': 'FREINEZ',
  'cue.left': 'VIRAGE À GAUCHE',
  'cue.right': 'VIRAGE À DROITE',
  'cue.offTrack': 'HORS PISTE',
  'cue.lateBrake': 'freinage trop tardif',
  'cue.rejoin.left': 'PISTE À GAUCHE',
  'cue.rejoin.right': 'PISTE À DROITE',
  'cue.rejoin.ahead': 'PISTE DEVANT',
  'cue.metres': '{n} m',
  'cue.pressR': 'R pour revenir',
  'msg.boostEmpty': 'BOOST EN RECHARGE',
  'msg.rejoined': 'DE RETOUR EN PISTE',
  'msg.rejoinWait': 'RETOUR DANS UN INSTANT',
  'msg.resumed': 'REPRISE',
  'unit.km': 'km',
};
