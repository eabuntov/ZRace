...
export default {
  ...
  'ui.selected': 'GEWÄHLT',
  'summary.laps.one': '{n} Runde',
  'summary.laps.other': '{n} Runden',
  'summary.rivals.one': '{n} Gegner',
  'summary.rivals.other': '{n} Gegner',
  'summary.timeTrial': 'Zeitfahren — nur du und die Uhr',
  'summary.best': 'Deine beste Runde hier: {time}',
  'summary.noBest': 'Hier noch keine Runde gefahren',
  'options.quality': 'GRAFIKQUALITÄT',
  'quality.auto': 'AUTO',
  'quality.performance': 'LEISTUNG',
  'quality.quality': 'QUALITÄT',
  'options.qualityNote': 'Leistung zeichnet weniger Pixel, schaltet das Leuchten ab, dünnt die Landschaft aus und hält die Gegner einfach. Qualität zeichnet alles in voller Auflösung. Auto beginnt dazwischen und passt sich zwischen den Rennen an, je nachdem, wie flüssig das letzte lief.',
  'options.qualityNow': 'Auf diesem Rechner läuft gerade: {tier}.',
  'tier.0': 'LEISTUNG',
  'tier.1': 'AUSGEWOGEN',
  'tier.2': 'QUALITÄT',
  'options.leanNote': 'Im Leistungsmodus bleibt das vorerst aus.',
  'options.cues': 'FAHRHINWEISE',
  'options.cuesNote': 'Kündigt Bremspunkte und die Richtung der nächsten Kurve kurz vorher an. Dass du von der Strecke abgekommen bist, wird immer angezeigt.',
  'hud.boostReady': 'BOOST BEREIT',
  'hud.startHint': '{key} HALTEN · LOS, WENN DIE LICHTER AUSGEHEN',
  'hud.startReady': 'BEREIT · LOS, WENN DIE LICHTER AUSGEHEN',
  'cam.chase': 'VERFOLGERKAMERA',
  'cam.close': 'NAHE KAMERA',
  'cam.bonnet': 'MOTORHAUBE',
  'hint.title': 'Steuerung',
  'hint.accel': 'Gas',
  'hint.steer': 'lenken',
  'hint.boost': 'Boost',
  'hint.camera': 'Kamera',
  'hint.dismiss': 'VERSTANDEN',
  'cue.brake': 'BREMSEN',
  'cue.left': 'LINKSKURVE',
  'cue.right': 'RECHTSKURVE',
  'cue.offTrack': 'NEBEN DER STRECKE',
  'cue.lateBrake': 'zu spät gebremst',
  'cue.rejoin.left': 'STRECKE LINKS',
  'cue.rejoin.right': 'STRECKE RECHTS',
  'cue.rejoin.ahead': 'STRECKE VORAUS',
  'cue.metres': '{n} m',
  'cue.pressR': 'R zum Zurücksetzen',
  'msg.boostEmpty': 'BOOST LÄDT',
  'msg.rejoined': 'ZURÜCK AUF DER STRECKE',
  'msg.rejoinWait': 'GLEICH WIEDER MÖGLICH',
  'msg.resumed': 'WEITER',
  'unit.km': 'km',
};
